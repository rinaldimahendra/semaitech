              ...
              <div class="col-12 col-md-12 col-lg-5">
                <div class="card profile-widget">
                  ...
                  <div class="profile-widget-description">
                    ...
                    <div class="profile-widget-name"> <?= $data_user['nama_user']; ?> <div class="text-muted d-inline font-weight-normal"><div class="slash"></div> Admin SemaiTech</div></div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" name="provinsi" value="<?= $data_user['provinsi']; ?>">
                          </div>
                        </div>
                        <div class="row">
                          <div class="form-group col-6">
